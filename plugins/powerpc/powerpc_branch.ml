...
(** Branch Instructions, Branch Page 37 of IBM Power ISATM Version 3.0 B
...
(** Branch Instructions, Branch Conditional Page 37 of IBM Power ISATM Version
...
(** Branch Instructions, Branch Conditional to Link Cpu.Register Page 38 of IBM
...
(** Branch Instructions extended mnemonic, branch to LR unconditionally. Page
    792 of IBM Power ISATM Version 3.0 B examples: 4e 80 00 20 blr 4e 80 00 21
    blrl *)
let blr cpu _ops =
  let sh = unsigned const byte 2 in
...
(** Branch Instructions, Branch Conditional to Count Cpu.Register Page 38 of IBM
...
(** Branch Instructions extended mnemonic, branch to CTR unconditionally. Page
    792 of IBM Power ISATM Version 3.0 B examples: 4e 80 04 20 bctr 4e 80 04 21
    bctrl *)
let bctr cpu _ops =
  let sh = unsigned const byte 2 in
...
(** Branch Instructions, Branch Conditional to Target Cpu.Register Page 39 of
