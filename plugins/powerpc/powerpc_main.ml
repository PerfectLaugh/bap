...
let () =
  Config.manpage
    [ `S "DESCRIPTION"; `P "Provides lifter for PowerPC architecture." ]
...
let () =
  Config.declare_extension ~doc:"provides the PowerPC lifter"
    ~provides:[ "semantics"; "lifter"; "powerpc" ] (fun { get } ->
