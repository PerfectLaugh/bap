...
let base_var mode reg =
  ...
  | Some reg -> (
      (if mode = X86_types.X86 then
         ...
         | `R8B | `R9B | `R10B | `R11B | `R12B | `R13B | `R14B | `R15B | `R8W
         | `R9W | `R10W | `R11W | `R12W | `R13W | `R14W | `R15W | `R8D | `R9D
         | `R10D | `R11D | `R12D | `R13D | `R14D | `R15D
         | #r64
         | `RIP | `XMM8 | `YMM8 | `XMM9 | `YMM9 | `XMM10 | `YMM10 | `XMM11
         | `YMM11 | `XMM12 | `YMM12 | `XMM13 | `YMM13 | `XMM14 | `YMM14 | `XMM15
         | `YMM15 ->
