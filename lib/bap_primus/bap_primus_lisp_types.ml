...
type typ = Any | Symbol | Name of string | Type of int
...
type token = Source.token = Atom of string | List of tree list
...
and fmt = Lit of string | Pos of int
and binding = Dynamic of KB.Name.t | Static of var list * ast
