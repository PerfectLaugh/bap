...
let unknown =
  let unknown = Theory.Value.Sort.Name.declare ~package:"bap" "Unknown" in
...
module Generator = struct
  ...
  let generator = KB.Class.declare ~package:"bap-internal" "var-generator" Gen
  ...
  include
    Binable.Of_binable_with_uuid
      ...
      (struct
        ...
        let caller_identity =
          Bin_shape.Uuid.of_string "f5bbbd23-6f83-4ba6-9090-26e38c169526"
      end)
