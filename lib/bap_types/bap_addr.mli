(** Extends [Bitvector] module with extra functions.
    ...
    Fields of this structure will be added to an [Addr] module exposed in
    standard interface module [Std].

    This is a place, where we can add functions to a bitvector interface, that
    corresponds mostly to using bitvectors as a representation of an address. *)
