...
let addr_of_word_size = function Word_size.W32 -> `r32 | Word_size.W64 -> `r64
let word_of_addr_size = function `r32 -> Word_size.W32 | `r64 -> Word_size.W64
...
module T = struct
  ...
  let version = "1.0.0"
  let pp fmt n = fprintf fmt "u%u" (in_bits n)
  let hash = in_bytes
end
