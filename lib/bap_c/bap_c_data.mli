...
(** C Data model.
    ...
    A value is backed by a datum - a sequence of bits that represents the value.
    This module also defines models for integer representation. *)
...
(** A C Object representation.
    ...
    The type is parameterized with the object layout representation to enable
    the recursive definition of the generalized layout type.
...
(** abstraction of a С datum.
    ...
    The datum is a sequence of bits that represents a C object. We abstract
    datum as either an immediate value of the given size, or a sequence of data,
    or a pointer to a datum.
...
type t = (value, Size.t) datum [@@deriving bin_io, compare, sexp]
