...
module Make (M : Monad.S2) = struct
  ...
  class ['e] base =
    object (self)
      ...
      method map_pointer =
        self#visit self#enter_pointer self#do_map_pointer self#leave_pointer

      method enter_function _ = M.return ()
      method leave_function _ = M.return ()

      method map_function =
        self#visit self#enter_function self#do_map_function self#leave_function

      method enter_union _ = M.return ()
      method leave_union _ = M.return ()

      method map_union =
        self#visit self#enter_union self#do_map_union self#leave_union

      method enter_structure _ = M.return ()
      method leave_structure _ = M.return ()

      method map_structure =
        self#visit self#enter_structure self#do_map_structure
      ...
      method map_cv_qualifier =
        self#visit self#enter_cv_qualifier self#do_map_cv_qualifier
      ...
      method map_cvr_qualifier =
        self#visit self#enter_cvr_qualifier self#do_map_cvr_qualifier
      ...
      method map_integer =
        self#visit self#enter_integer self#do_map_integer self#leave_integer

      method enter_floating _ = M.return ()
      method leave_floating _ = M.return ()

      method map_floating =
        self#visit self#enter_floating self#do_map_floating self#leave_floating

      method enter_char _ = M.return ()
      method leave_char _ = M.return ()

      method map_char =
        self#visit self#enter_char self#do_map_char self#leave_char

      method enter_signed _ = M.return ()
      method leave_signed _ = M.return ()

      method map_signed =
        self#visit self#enter_signed self#do_map_signed self#leave_signed

      method enter_unsigned _ = M.return ()
      method leave_unsigned _ = M.return ()

      method map_unsigned =
        self#visit self#enter_unsigned self#do_map_unsigned self#leave_unsigned

      method enter_enum _ = M.return ()
      method leave_enum _ = M.return ()

      method map_enum =
        self#visit self#enter_enum self#do_map_enum self#leave_enum

      method enter_real _ = M.return ()
      method leave_real _ = M.return ()

      method map_real =
        self#visit self#enter_real self#do_map_real self#leave_real

      method enter_complex _ = M.return ()
      method leave_complex _ = M.return ()

      method map_complex =
        self#visit self#enter_complex self#do_map_complex self#leave_complex

      method enter_name _ = M.return ()
      method leave_name _ = M.return ()

      method map_name =
        self#visit self#enter_name self#do_map_name self#leave_name

      method enter_attrs _ = M.return ()
      method leave_attrs _ = M.return ()

      method map_attrs =
        self#visit self#enter_attrs self#do_map_attrs self#leave_attrs

      method enter_attr _ = M.return ()
      method leave_attr _ = M.return ()

      method map_attr =
        self#visit self#enter_attr self#do_map_attr self#leave_attr

      method private do_map_type : t -> (t, 'e) m =
        function
        | `Void -> self#map_void `Void
        | `Array spec ->
            self#map_spec self#map_cvr_qualifier self#map_array spec
            >>| fun spec -> `Array spec
        | `Basic spec ->
            self#map_spec self#map_cv_qualifier self#map_basic spec
            >>| fun spec -> `Basic spec
        | `Pointer spec ->
            self#map_spec self#map_cvr_qualifier self#map_pointer spec
            >>| fun spec -> `Pointer spec
        | `Function spec ->
            self#map_spec self#map_no_qualifier self#map_function spec
            >>| fun spec -> `Function spec
        | `Union spec ->
            self#map_spec self#map_no_qualifier self#map_union spec
            >>| fun spec -> `Union spec
        | `Structure spec ->
            self#map_spec self#map_no_qualifier self#map_structure spec
            >>| fun spec -> `Structure spec
      ...
      method private do_map_basic =
        function
        | #integer as t -> self#map_integer t >>| fun x -> (x :> basic)
        | #floating as t -> self#map_floating t >>| fun x -> (x :> basic)
      ...
      method private do_map_integer : integer -> (integer, 'e) m =
        function
        ...
        | `enum fields -> self#map_enum fields >>| fun fields -> `enum fields

      method private do_map_floating : floating -> (floating, 'e) m =
        function
      ...
      method private do_map_array { Array.element; size } =
        self#map_type element >>| fun element -> { Array.element; size }

      method private map_compound { Compound.name; fields } =
        self#map_fields fields >>= fun fields ->
        self#map_name name >>= fun name -> M.return Compound.{ name; fields }
...
module Search = struct
  ...
  let finished x : ('a, 'e) t = SM.put (Some x) >>= fun () -> SM.return None
  ...
  include Monad.Make2 (struct
    ...
    let bind x f = x >>= function None -> SM.return None | Some x -> f x
    let map = `Define_using_bind
  end)
end
